...
- [ ] **Task 1.1: Database Schema Updates (SQLAlchemy)**
...
- [ ] **Task 1.4: Refactor Auth Endpoints**
...
- [ ] **Task 2.1: Resend Setup & Configuration**
...
- [ ] **Task 2.2: Email Dispatch Service**
...
- [ ] **Task 2.4: Verification Endpoint**
...
- [ ] **Task 3.1: Get Current User Details**
...
- [ ] **Task 4.1: Update Registration Form (`/signup`)**
...
- [ ] **Task 4.2: Email Verification Page (`/verify-email`)**
...
- [ ] **Task 4.3: Account Dashboard Layout (`/account`)**
...
- [ ] **Task 4.5: Danger Zone (Delete Account)**
